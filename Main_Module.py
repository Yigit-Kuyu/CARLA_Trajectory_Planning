...
## Yörüngenin waypointL'eir kullanılarak tanımlanabildiği, belirli bir yörüngeyi takip etmek için bir denetleyici değerlendirmesi.
...
def exec_waypoint_nav_demo(args):
    ...
    with make_carla_client(args.host, args.port) as client:
        ...
        for frame in range(TOTAL_EPISODE_FRAMES):
            ...
            ## O anki örnekte, behaviour ve local planning'i çalıştırın.
            ## Her controller için local path'i  update etmek, tracking performans ile alakalı sorunlar üretecektir.
            ## Bu nedenle, local planner, simülasyon frekansının bir bölümü olan bir frekansta çalışmaya benzer olduğundan, LP_FREQUENCY_DIVISOR 
            ## değişkeninde saklanan her X frame 'i günceller.
            if frame % LP_FREQUENCY_DIVISOR == 0:
                ...
                ## Velocity profile ve waypointleri hesapla.
                ## Hız profilinin dinamik  engel yönetimini bilgilendirmek için öndeki aracı kullan.
                ## Bu senaryoda tek dinamik engel indeks 1'deki öndeki araçtır.
