...
class PathOptimizer:
    ...
    ## Belirli bir hedef noktasına, (xf, yf, tf), bir spiral trajectory hesaplamak için optimizasyon problemini kurar.
    def optimize_spiral(self, xf, yf, tf):
        ...
        ## Düz çizgi mesafesi, hedefe giden herhangi bir yolun yay uzunluğunda (arc length) bir alt sınır görevi görür.
        ...
        ## İlk değişkenler, yay uzunluğuna sahip düz bir çizgiye karşılık gelir.
        ## p1 ve p2, p1 ve p2 noktalarındaki eğriliklerdir ve sf, spiral için son yay uzunluğudur. 
        ## Zaten p0 ve p4'ü (ilk ve son noktaların eğriliği olarak) sıfır olarak ayarlanmıştır
        ...
        ## Burada her bir optimizasyon değişkeni için [alt, üst] sınırları belirleyeceğiz.
        ## İlk iki değişken sırasıyla yol boyunca, yolun 1/3'ünün ve yolun 2/3'ünün eğriliğe karşılık gelir.
        ## Sonuç olarak, eğriliklerinin [-0.5, 0.5] aralığında olması gerekir. 
        ## Üçüncü değişken yay uzunluğudur (arc length), üst sınırı yoktur ve düz çizgi yay uzunluğunun alt sınırını alır.
        ...
        ## Burada spiralimizi optimize etmek için scipy.optimize.minimize'ı çağıracağız.
        ## Hedef ve gradyan size self.objective ve self.objective_grad tarafından verilir.
        ## Sınırlar yukarıda hesaplanır ve optimize edici için başlangıç değişkenleri p0 tarafından belirlenir.
        ## L-BFGS B optimizasyon yöntemlerini kullanmalısınız.
    ...
    ## Bu kod verilen yay uzunluğu (arc length) listesinden ve sprial parametreler a,b,c,d 'den theta
    ## degerlerini hesaplar.
    ...
    ## Bu fonksiyon, Path'in ayrık x,y ve theta noktalarını elde etmek için 
    ## spiral trajectory'yi yay uzunluğu (arc length) boyunca örnekler.
    def sample_spiral(self, p):
        ...
        ## Teta, x ve y noktalarını, uniform örneklenmiş yay uzunluğu noktalarından, s_points, hesaplayın (p[4] spiral yay uzunluğudur).
        ## theta değerlerini s değerlerinden hesaplamak için self.thetaf() kullanın.
        ## scipy.integrate.cumtrapz() fonksiyonu önemlidir.
    ...
    def objective(self, p):
        ...
        """
        ## Optimize edici, spiral parametre değişkenlerinin 3'ünü serbestçe hareket ettirebilir. 
        ## Diğer ikisi sınır koşulları nedeniyle sabittir.
